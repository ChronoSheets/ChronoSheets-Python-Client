...
class UserPayRatesApi(object):
    ...
    def user_pay_rates_create_pay_rate(self, request, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        >>> thread = api.user_pay_rates_create_pay_rate(request, x_chronosheets_auth, async_req=True)
        >>> result = thread.get()
    ...
    def user_pay_rates_create_pay_rate_with_http_info(self, request, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_pay_rates_create_pay_rate_with_http_info(request, x_chronosheets_auth, async_req=True)
        >>> result = thread.get()

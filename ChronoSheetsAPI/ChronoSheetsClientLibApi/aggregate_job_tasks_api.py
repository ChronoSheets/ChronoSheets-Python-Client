...
class AggregateJobTasksApi(object):
    ...
    def aggregate_job_tasks_get_aggregate_job_tasks(self, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.aggregate_job_tasks_get_aggregate_job_tasks_with_http_info(x_chronosheets_auth, **kwargs)  # noqa: E501
        else:
            (data) = self.aggregate_job_tasks_get_aggregate_job_tasks_with_http_info(x_chronosheets_auth, **kwargs)  # noqa: E501
            return data
    ...
    def aggregate_job_tasks_get_aggregate_job_tasks_with_http_info(self, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.aggregate_job_tasks_get_aggregate_job_tasks_with_http_info(x_chronosheets_auth, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method aggregate_job_tasks_get_aggregate_job_tasks" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('x_chronosheets_auth' not in params or
            ...
            raise ValueError("Missing the required parameter `x_chronosheets_auth` when calling `aggregate_job_tasks_get_aggregate_job_tasks`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CSApiResponseListAggregateJobCode',  # noqa: E501

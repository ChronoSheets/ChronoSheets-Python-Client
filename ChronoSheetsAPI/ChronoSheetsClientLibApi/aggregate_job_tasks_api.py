...
class AggregateJobTasksApi(object):
    ...
    def aggregate_job_tasks_get_aggregate_job_tasks_with_http_info(self, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseListAggregateJobCode, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `aggregate_job_tasks_get_aggregate_job_tasks`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ApiResponseListAggregateJobCode',  # noqa: E501

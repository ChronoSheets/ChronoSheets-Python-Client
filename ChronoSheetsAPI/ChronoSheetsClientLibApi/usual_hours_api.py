...
class UsualHoursApi(object):
    ...
    def usual_hours_get_usual_hours_with_http_info(self, user_id, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseListUsualHoursDay, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('user_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `user_id` when calling `usual_hours_get_usual_hours`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `usual_hours_get_usual_hours`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ApiResponseListUsualHoursDay',  # noqa: E501
    ...
    def usual_hours_set_usual_hours(self, x_chronosheets_auth, request, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str x_chronosheets_auth: The ChronoSheets Auth Token (required)
        :param SetUsualHoursRequest request: A Set UsualHours Request object containing updated data.  Make sure to specify the Day types in the request object so that ChronoSheets knows which Days to update (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.usual_hours_set_usual_hours_with_http_info(x_chronosheets_auth, request, **kwargs)  # noqa: E501

    def usual_hours_set_usual_hours_with_http_info(self, x_chronosheets_auth, request, **kwargs):  # noqa: E501
        """Set usual hours (rostered hours) for an employee.  Requires the 'ManageOrganisationUsers' permission.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.usual_hours_set_usual_hours_with_http_info(x_chronosheets_auth, request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_chronosheets_auth'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `usual_hours_set_usual_hours`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `usual_hours_set_usual_hours`")  # noqa: E501

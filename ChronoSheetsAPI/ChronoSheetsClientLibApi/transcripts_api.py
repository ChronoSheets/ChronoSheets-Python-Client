...
class TranscriptsApi(object):
    ...
    def transcripts_get_my_transcript_with_http_info(self, file_attachment_id, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseTranscription, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('file_attachment_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `file_attachment_id` when calling `transcripts_get_my_transcript`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `transcripts_get_my_transcript`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='ApiResponseTranscription',  # noqa: E501
    ...
    def transcripts_get_my_transcripts_with_http_info(self, start_date, end_date, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('start_date' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `start_date` when calling `transcripts_get_my_transcripts`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('end_date' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `end_date` when calling `transcripts_get_my_transcripts`")  # noqa: E501
        # verify the required parameter 'x_chronosheets_auth' is set
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_chronosheets_auth'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `transcripts_get_my_transcripts`")  # noqa: E501

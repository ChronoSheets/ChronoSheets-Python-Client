...
class OrganisationGroupUsersApi(object):
    ...
    def organisation_group_users_get_organisation_group_users_with_http_info(self, org_group_id, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organisation_group_users_get_organisation_group_users_with_http_info(org_group_id, x_chronosheets_auth, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('org_group_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_group_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_group_id` when calling `organisation_group_users_get_organisation_group_users`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `organisation_group_users_get_organisation_group_users`")  # noqa: E501
        ...
        query_params = []
        if 'org_group_id' in local_var_params and local_var_params['org_group_id'] is not None:  # noqa: E501
            query_params.append(('orgGroupId', local_var_params['org_group_id']))  # noqa: E501
    ...
    def organisation_group_users_update_organisation_group_users(self, x_chronosheets_auth, request, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.organisation_group_users_update_organisation_group_users_with_http_info(x_chronosheets_auth, request, **kwargs)  # noqa: E501

    def organisation_group_users_update_organisation_group_users_with_http_info(self, x_chronosheets_auth, request, **kwargs):  # noqa: E501
        """Set the users who belong to an organisation group.    Requires the 'ManageOrganisationGroups' permissions.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.organisation_group_users_update_organisation_group_users_with_http_info(x_chronosheets_auth, request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_chronosheets_auth' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_chronosheets_auth'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_chronosheets_auth` when calling `organisation_group_users_update_organisation_group_users`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `request` when calling `organisation_group_users_update_organisation_group_users`")  # noqa: E501

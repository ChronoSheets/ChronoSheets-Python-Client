...
class OrganisationApi(object):
    ...
    def organisation_get_organisation_with_http_info(self, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        if ('x_chronosheets_auth' not in params or
            ...
            raise ValueError("Missing the required parameter `x_chronosheets_auth` when calling `organisation_get_organisation`")  # noqa: E501
    ...
    def organisation_update_organisation_with_http_info(self, request, x_chronosheets_auth, **kwargs):  # noqa: E501
        ...
        if ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `organisation_update_organisation`")  # noqa: E501
        # verify the required parameter 'x_chronosheets_auth' is set
        if ('x_chronosheets_auth' not in params or
                params['x_chronosheets_auth'] is None):
            raise ValueError("Missing the required parameter `x_chronosheets_auth` when calling `organisation_update_organisation`")  # noqa: E501

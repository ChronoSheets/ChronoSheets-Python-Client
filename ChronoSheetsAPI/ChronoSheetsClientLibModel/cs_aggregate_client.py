...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.cs_cs_aggregate_project import CSAggregateProject  # noqa: F401,E501


class CSAggregateClient(object):
    ...
    """
    swagger_types = {
        'client_projects': 'list[CSAggregateProject]',
        'id': 'int',
        'organisation_id': 'int',
        'client_name': 'str',
    ...
    def __init__(self, client_projects=None, id=None, organisation_id=None, client_name=None, client_address_line1=None, client_address_line2=None, client_suburb=None, client_state=None, client_post_code=None, person_of_contact=None, client_phone_number=None, client_mobile_number=None, client_email_address=None, client_web_url=None, project_count=None):  # noqa: E501
        """CSAggregateClient - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CSAggregateClient):
            return False

...
class CSAggregateProject(object):
    ...
    def __init__(self, id=None, client_id=None, organisation_id=None, project_name=None, cost_estimation=None, start_date=None, end_date=None):  # noqa: E501
        """CSAggregateProject - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CSAggregateProject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CSAggregateProject):
            return False

...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.cs_cs_project_costing_report_item import CSProjectCostingReportItem  # noqa: F401,E501


class CSApiResponseListProjectCostingReportItem(object):
    ...
    """
    swagger_types = {
        'data': 'list[CSProjectCostingReportItem]',
        'status': 'str',
        'message': 'str'
    }
    ...
    def __init__(self, data=None, status=None, message=None):  # noqa: E501
        """CSApiResponseListProjectCostingReportItem - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CSApiResponseListProjectCostingReportItem):
            return False

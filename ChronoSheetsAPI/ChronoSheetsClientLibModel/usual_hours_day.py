...
class UsualHoursDay(object):
    ...
    def __init__(self, day_type=None, time_slots=None, delete_usual_hours=None, local_vars_configuration=None):  # noqa: E501
        """UsualHoursDay - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def day_type(self):
        """Gets the day_type of this UsualHoursDay.  # noqa: E501

        Specify which day this collection of Roster timeslots is for (Monday-Sunday)  # noqa: E501

        :return: The day_type of this UsualHoursDay.  # noqa: E501
        :rtype: str
        """
    ...
    def day_type(self, day_type):
        """Sets the day_type of this UsualHoursDay.

        Specify which day this collection of Roster timeslots is for (Monday-Sunday)  # noqa: E501

        :param day_type: The day_type of this UsualHoursDay.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_slots(self):
        """Gets the time_slots of this UsualHoursDay.  # noqa: E501

        A collection of TimeSlots within this day  # noqa: E501

        :return: The time_slots of this UsualHoursDay.  # noqa: E501
        :rtype: list[TimeSlot]
        """
    ...
    def time_slots(self, time_slots):
        """Sets the time_slots of this UsualHoursDay.

        A collection of TimeSlots within this day  # noqa: E501

        :param time_slots: The time_slots of this UsualHoursDay.  # noqa: E501
        :type: list[TimeSlot]
        """
    ...
    def delete_usual_hours(self):
        """Gets the delete_usual_hours of this UsualHoursDay.  # noqa: E501

        Mark here which existing UsualHours are to be deleted  # noqa: E501

        :return: The delete_usual_hours of this UsualHoursDay.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def delete_usual_hours(self, delete_usual_hours):
        """Sets the delete_usual_hours of this UsualHoursDay.

        Mark here which existing UsualHours are to be deleted  # noqa: E501

        :param delete_usual_hours: The delete_usual_hours of this UsualHoursDay.  # noqa: E501
        :type: list[int]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UsualHoursDay):
            return False

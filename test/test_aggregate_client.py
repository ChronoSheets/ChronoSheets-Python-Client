...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.aggregate_client import AggregateClient  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestAggregateClient(unittest.TestCase):
    """AggregateClient unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AggregateClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.aggregate_client.AggregateClient()  # noqa: E501
        if include_optional :

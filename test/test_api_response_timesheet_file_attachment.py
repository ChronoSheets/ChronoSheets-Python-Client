...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.api_response_timesheet_file_attachment import ApiResponseTimesheetFileAttachment  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestApiResponseTimesheetFileAttachment(unittest.TestCase):
    """ApiResponseTimesheetFileAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiResponseTimesheetFileAttachment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.api_response_timesheet_file_attachment.ApiResponseTimesheetFileAttachment()  # noqa: E501
        if include_optional :
            return ApiResponseTimesheetFileAttachment(
                data = ChronoSheetsAPI.models.timesheet_file_attachment.TimesheetFileAttachment(
                    timesheet_id = 56, 
    ...
    def testApiResponseTimesheetFileAttachment(self):
        """Test ApiResponseTimesheetFileAttachment"""

...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.api_response_organisation import ApiResponseOrganisation  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestApiResponseOrganisation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test ApiResponseOrganisation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.api_response_organisation.ApiResponseOrganisation()  # noqa: E501
        if include_optional :
            return ApiResponseOrganisation(
                data = ChronoSheetsAPI.models.organisation.Organisation(
                    id = 56, 
                    name = '0', 
                    address_line01 = '0', 
                    address_line02 = '0', 
    ...
    def testApiResponseOrganisation(self):
        """Test ApiResponseOrganisation"""

...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.api_response_for_paginated_list_timesheet_file_attachment import ApiResponseForPaginatedListTimesheetFileAttachment  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestApiResponseForPaginatedListTimesheetFileAttachment(unittest.TestCase):
    """ApiResponseForPaginatedListTimesheetFileAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiResponseForPaginatedListTimesheetFileAttachment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.api_response_for_paginated_list_timesheet_file_attachment.ApiResponseForPaginatedListTimesheetFileAttachment()  # noqa: E501
        if include_optional :
            return ApiResponseForPaginatedListTimesheetFileAttachment(
                total_set_count = 56, 
                data = [
                    ChronoSheetsAPI.models.timesheet_file_attachment.TimesheetFileAttachment(
                        timesheet_id = 56, 
    ...
    def testApiResponseForPaginatedListTimesheetFileAttachment(self):
        """Test ApiResponseForPaginatedListTimesheetFileAttachment"""

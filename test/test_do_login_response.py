...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.do_login_response import DoLoginResponse  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestDoLoginResponse(unittest.TestCase):
    """DoLoginResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DoLoginResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.do_login_response.DoLoginResponse()  # noqa: E501
        if include_optional :

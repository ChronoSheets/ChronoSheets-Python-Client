...
from ChronoSheetsAPI.ChronoSheetsClientLibModel.api_response_for_paginated_list_org_report_transcript import ApiResponseForPaginatedListOrgReportTranscript  # noqa: E501
from ChronoSheetsAPI.rest import ApiException

class TestApiResponseForPaginatedListOrgReportTranscript(unittest.TestCase):
    """ApiResponseForPaginatedListOrgReportTranscript unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiResponseForPaginatedListOrgReportTranscript
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ChronoSheetsAPI.models.api_response_for_paginated_list_org_report_transcript.ApiResponseForPaginatedListOrgReportTranscript()  # noqa: E501
        if include_optional :
            return ApiResponseForPaginatedListOrgReportTranscript(
                total_set_count = 56, 
                data = [
                    ChronoSheetsAPI.models.org_report_transcript.OrgReportTranscript(
                        finished_job = True, 
    ...
    def testApiResponseForPaginatedListOrgReportTranscript(self):
        """Test ApiResponseForPaginatedListOrgReportTranscript"""
